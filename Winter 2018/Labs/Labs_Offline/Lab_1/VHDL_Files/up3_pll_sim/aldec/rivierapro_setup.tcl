...
# ACDS 17.1 590 win32 2018.01.28.13:52:47
# ----------------------------------------
...
# ----------------------------------------
# If up3_pll is one of several IP cores in your
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/up3_pll.vho"
}
